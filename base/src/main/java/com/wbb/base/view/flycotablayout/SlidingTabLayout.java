package com.wbb.base.view.flycotablayout;
...
import com.wbb.base.view.flycotablayout.utils.UnreadMsgUtils;
import com.wbb.base.view.flycotablayout.widget.MsgView;
...
public class SlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mIndicatorGradient = ta.getBoolean(R.styleable.SlidingTabLayout_tl_indicator_gradient, false);
        ...
        if (mIndicatorStyle == STYLE_TRIANGLE) {
            ...
            if (mIndicatorGradient) {
                if (mIndicatorHeight > 0) {
                    ...
                    gradientColors[0] = mIndicatorStartColor;
                    gradientColors[1] = mIndicatorEndColor;
                    mIndicatorDrawable = new GradientDrawable(GradientDrawable.Orientation.LEFT_RIGHT, gradientColors);
                    if (mIndicatorGravity == Gravity.BOTTOM) {
                        mIndicatorDrawable.setBounds((int) (paddingLeft + (int) mIndicatorMarginLeft + mIndicatorRect.left - (selectTextView.getWidth() - mIndicatorWidth) / 2),
