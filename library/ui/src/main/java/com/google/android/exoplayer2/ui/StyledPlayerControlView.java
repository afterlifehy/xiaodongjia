...
public class StyledPlayerControlView extends FrameLayout {
    ...
    private OnPlayLinsener mOnPlayLinsener;
     ...
     * 设置当前父类回调
     *
     * @param mOnPlayLinsener
     */
    public void setOnPlayLinsener(OnPlayLinsener mOnPlayLinsener) {
        this.mOnPlayLinsener = mOnPlayLinsener;
        controlViewLayoutManager.setOnPlayLinsener(mOnPlayLinsener);
     ...
     */
    public void show(boolean isUserClick) {
        controlViewLayoutManager.show(isUserClick);
    }

    /**
     * Hides the controller.
     */
    public void hide(boolean isUserClick) {
        controlViewLayoutManager.hide(isUserClick);
    }
