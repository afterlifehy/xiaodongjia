 ...
 */
public class StyledPlayerView extends FrameLayout implements AdsLoader.AdViewProvider, OnPlayLinsener {


    @Override
    public boolean isPlayEnd() {
        if (componentListener != null) {
            return componentListener.getCurrentPlayStatus() == Player.STATE_ENDED;
        }
        return false;
    }
    ...
    public StyledPlayerView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        if (customController != null) {
            ...
            controller.setOnPlayLinsener(this);
     ...
     * @return
     */
    public StyledPlayerControlView getControllerView() {
        return controller;
    }
    ...
    public void showController() {
        showController(shouldShowControllerIndefinitely(), false);
    }
    ...
    public boolean performClick() {
        super.performClick();
        return toggleControllerVisibility(true);
    }
    ...
    private boolean toggleControllerVisibility(boolean isUserClick) {
        if (!useController() || player == null) {
            return false;
        }
        if (!controller.isFullyVisible()) {
            maybeShowController(true, 10001);
            return true;
        } else if (controllerHideOnTouch) {
            controller.hide(isUserClick);
            return true;
        }
        return false;
    }
     ...
     */
    private void maybeShowController(boolean isForced, int index) {
        ...
        if (useController()) {
            ...
            if (isForced || wasShowingIndefinitely || shouldShowIndefinitely) {
                showController(shouldShowIndefinitely, index == 10001);
            }
        }
    }
    ...
    private void showController(boolean showIndefinitely, boolean isUserClick) {
        if (!useController()) {
            return;
        }
        controller.setShowTimeoutMs(showIndefinitely ? 0 : controllerShowTimeoutMs);
        controller.show(isUserClick);//keey
    }
    ...
    private final class ComponentListener
        ...
        //当前播放状态
        private int mCurrentPlayStatus = Player.STATE_IDLE;
        ...
        public void onPlaybackStateChanged(@Player.State int playbackState) {
            this.mCurrentPlayStatus = playbackState;
            updateBuffering();
            updateErrorMessage();
        ...
        public boolean onSingleTapUp(MotionEvent e) {
            return toggleControllerVisibility(false);
        }
